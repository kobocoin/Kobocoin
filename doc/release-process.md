...
* Update translations (ping wumpus on IRC) see [translation_process.md](https://github.com/kobocoin/kobocoin/blob/master/doc/translation_process.md#synchronising-translations).
...
* Update hardcoded [seeds](/contrib/seeds/README.md), see [this pull request](https://github.com/kobocoin/kobocoin/pull/7415) for an example.
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/kobocoin/kobocoin.git
