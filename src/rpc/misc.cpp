...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total kobocoin balance of the wallet\n"
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nReturn information about the given kobocoin address.\n"
            "\nArguments:\n"
            "1. \"bitcoinaddress\"     (string, required) The kobocoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"kobocoinaddress\", (string) The kobocoin address validated\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"FN7t5A29MVfZmTMCyNVwS1nAFvg9GfFzP8\"")
            + HelpExampleRpc("validateaddress", "\"FN7t5A29MVfZmTMCyNVwS1nAFvg9GfFzP8\"")
        );
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are kobocoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) kobocoin address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
            ...
            + HelpExampleCli("createmultisig", "2 \"[\\\"FN7t5A29MVfZmTMCyNVwS1nAFvg9GfFzP8\\\",\\\"FBzzw3PMUhz1qSXeXoG7zLDKQkrb3AzSXn\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("createmultisig", "2, \"[\\\"FN7t5A29MVfZmTMCyNVwS1nAFvg9GfFzP8\\\",\\\"FBzzw3PMUhz1qSXeXoG7zLDKQkrb3AzSXn\\\"]\"")
        ;
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"bitcoinaddress\"  (string, required) The kobocoin address to use for the signature.\n"
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"FN7t5A29MVfZmTMCyNVwS1nAFvg9GfFzP8\", \"signature\", \"my message\"")
        );
