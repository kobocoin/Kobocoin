// Copyright (c) 2014 The kobocoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("kobocoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("kobocoin-smsg-pow"); // Make this thread recognisable
